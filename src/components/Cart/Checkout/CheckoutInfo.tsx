    ...
    return (
        <form className="w-full grid grid-cols-2 gap-6 py-6 appear">
            ...
            <div className='col-start-2 col-end-3'>
                ...
                <input name="lastname" placeholder="" className='w-full h-10 mt-2 text-base px-3 border border-gray-300 outline-none' type="text" />
            </div>
            <div className='col-start-1 col-end-2'>
                <label htmlFor="email" className='font-semibold'>Email Address</label>
                <input name="email" type="email" placeholder="" className='w-full h-10 mt-2 text-base px-3 border border-gray-300 outline-none' />
            </div>
            <div className='col-start-2 col-end-3'>
                <label htmlFor="phone_number" className='font-semibold'>Phone Number</label>
                <input name="phone_number" placeholder="" className='w-full h-10 mt-2 text-base px-3 border border-gray-300 outline-none' type="tel" />
            </div>
            <div className='col-start-1 col-end-3'>
                <label htmlFor="address" className='font-semibold'>Address</label>
                <input name="address" placeholder="123 Main St" className='w-full h-10 mt-2 text-base px-3 border border-gray-300 outline-none' type="text" />
            </div>
            <div className='col-start-1 col-end-3'>
                <label htmlFor="address2" className='font-semibold'>Address <span className='opacity-50'>(Optional)</span></label>
                <input name="address2" placeholder="123 Main St" className='w-full h-10 mt-2 text-base px-3 border border-gray-300 outline-none' type="text" />
            </div>
            <div className='col-start-1 col-end-3'>
            ...
            <div className='col-start-1 col-end-2'>
                ...
                <input name="date" placeholder="04/09/2022" className='w-full h-10 mt-2 text-base px-3 border border-gray-300 outline-none' type="date" />
            </div>
            <div className='col-start-2 col-end-3'>
